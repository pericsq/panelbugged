...
<div class="card-body">
<div class="card-text">
<span class="float-right text-white-50 created_at">2021-11-08 14:25:17</span>
<ul>
<li>quest halloween dezactivat</li>
<li>reparat un bug ce facea ca, in anumite situatii, timpul de /nmute (mute pe chatul de ajutor) sa nu fie salvat dupa relog</li>
<li>marit timpul maxim de /nmute</li>
<li>rezolvate unele buguri legate de muzica ascultata in masina (/carradio)</li>
<li>playerii ce fac parte dintr-o mafie pot intra pe un turf doar dupa minim 2 minute de la conectarea pe server (/sec)</li>
<li>alte buguri reparate</li>
<li>optimizate unele timere</li>
</ul>
<p>-<del>comanda /checkcontract poate fi folosita doar de hitmanii cu rank 6+</del> (va fi reparat la urmatorul restart)</p>
</div>
</div>
